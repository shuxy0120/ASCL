...
import torch
# /home/liangshaoyang/.conda/envs/sxy/lib/python3.7/site-packages/pytorch_metric_learning/
from pytorch_metric_learning.distances import CosineSimilarity
from pytorch_metric_learning.utils import common_functions as c_f
from pytorch_metric_learning.utils import loss_and_miner_utils as lmu
from model.metrics.base_metric_loss_function import BaseMetricLossFunction
from model.metrics.mixins import WeightRegularizerMixin
...
class LargeMarginSoftmaxLoss(WeightRegularizerMixin, BaseMetricLossFunction):
    ...
    def get_cosine(self, embeddings, P):
        return self.distance(embeddings, P)
    ...
    def get_target_mask(self, embeddings, labels):
        ...
        # mask = labels.expand(batch_size, batch_size).eq(labels.expand(batch_size, batch_size).t()).float()
    ...
    def scale_logits(self, logits, embeddings, P):
        embedding_norms = self.distance.get_norm(embeddings)
        weight_norms = self.distance.get_norm(P, dim=0)
    ...
    def compute_loss(self, embeddings, labels, indices_tuple, ref_emb, ref_labels, C, P):
        ...
        cosine = self.get_cosine(embeddings, P)
        ...
        self.add_weight_regularization_to_loss_dict(loss_dict, P)
        return loss_dict
