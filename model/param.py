...
def parse_args():
    ...
    parser.add_argument('--optim', default='adamax')  # bert
    ...
    # Debugging
    parser.add_argument('--output', type=str, default='/home/liangshaoyang/sxy/vqa_mutant/lxmert/snap/base2')
    ...
    parser.add_argument('--loadLXMERT', dest='load_lxmert', type=str, default='/home/liangshaoyang/sxy/vqa_mutant/lxmert//snap/pretrained/pretrained',
